...
export default function ProjectCard({ title, image, href, onClick, className }: Props) {
  ...
  const base = "relative w-full overflow-hidden shadow-[inset_2px_2px_0_0_#fff,inset_-2px_-2px_0_0_#000] transition-all duration-250 ease-out hover:shadow-[inset_2px_2px_0_0_#fff,inset_-2px_-2px_0_0_#000,0_8px_16px_rgba(0,0,0,0.3)] hover:scale-[1.03] hover:-translate-y-1"
